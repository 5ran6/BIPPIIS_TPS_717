...
public class GBMSAPIJavaWrapperDefinesReturnCodes {
    ...
    public static int GBMSAPI_ERROR_CODE_METHOD_NOT_SUPPORTED = 31; // it should be treated as a warning
    public static int GBMSAPI_ERROR_CODE_OBJECT_TYPE_NOT_SUPPORTED = 32;
    public static int GBMSAPI_ERROR_CODE_SCAN_AREA_NOT_SUPPORTED = 33; // it should be treated as a warning
    ...
    public static int GBMSAPI_ERROR_CODE_FEATURE_NOT_SUPPORTED = 36; // it should be treated as a warning
