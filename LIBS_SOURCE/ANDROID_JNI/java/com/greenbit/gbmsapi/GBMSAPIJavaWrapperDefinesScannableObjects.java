...
public class GBMSAPIJavaWrapperDefinesScannableObjects {
     ...
     *	FLAT FINGERS													*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_FLAT_SINGLE_FINGER type
     ...
     *	ROLL FINGERS													*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLL_SINGLE_FINGER type
     ...
     *	SLAPS															*
     ********************************************************************/
// This object belongs to GBMSAPI_SBT_FLAT_THUMBS_2 type
    public static int GBMSAPI_SO_SLAP_2_THUMBS = 21;
    // This object belongs to GBMSAPI_SBT_FLAT_SLAP_4 type
    public static int GBMSAPI_SO_SLAP_4_LEFT = 22;
    public static int GBMSAPI_SO_SLAP_4_RIGHT = 23;
    // This object belongs to GBMSAPI_SBT_FLAT_SLAP_2 type
...
// Ver 2.10.0.0
     ...
     *	THENAR															*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_THENAR type
    public static int GBMSAPI_SO_ROLLED_THENAR_LEFT = 85;
    public static int GBMSAPI_SO_ROLLED_THENAR_RIGHT = 34;
    /********************************************************************
     *	ROLL JOINTS														*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_JOINT type
     ...
     *	PLAIN LEFT JOINTS												*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_PLAIN_JOINT_LEFT_SIDE type
     ...
     *	PLAIN RIGHT JOINTS												*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_PLAIN_JOINT_RIGHT_SIDE type
    ...
    /********************************************************************
     *	ROLLED CENTER JOINTS											*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_JOINT_CENTER type
     ...
     *	ROLL TIPS														*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_TIP type
...
// Ver 3.2.0.0
     ...
     *	ROLL TOP														*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_UP type
     ...
     *	ROLL DOWN														*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_DOWN type
...
// Ver 3.3.0.0
     ...
     *	ROLLED HYPOTHENAR												*
     ********************************************************************/
// These objects belong to GBMSAPI_SBT_ROLLED_HYPOTHENAR type
