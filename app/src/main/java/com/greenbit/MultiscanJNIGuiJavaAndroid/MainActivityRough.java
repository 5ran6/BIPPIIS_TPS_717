...
public class MainActivityRough extends AppCompatActivity implements IGreenbitLogger, IGbmsapiAcquisitionManagerCallback {
...
//        popup.show();
    ...
    public void LogAsDialog(String logStr) {
        ...
        Tools.toast(logStr, MainActivityRough.this);
    }
